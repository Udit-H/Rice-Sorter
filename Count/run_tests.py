...
VIDEOS_DIR = os.path.join(os.path.dirname(__file__), "countvids")

# Ground-truth grain counts (from reference image)
GT: dict = {
    "test_9_white_100.mp4":            100,
    "test_10_chalky_100.mp4":          100,
    "test_11_brown_100.mp4":          100,
    "test_12_black_41.mp4":          41,
    "test_13_mixed.mp4":          168,
    "test_14_yellow_100.mp4":          100,
}
...
def main():
    ...
    for fname in sorted(GT):
        ...
        print(f"\nProcessing: {fname}")
        det = process_video(vpath, rice_mode='universal', out_path=out_vid, verbose=True)
